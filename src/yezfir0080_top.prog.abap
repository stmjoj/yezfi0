...
* TABLES
*----------------------------------------------------------------------*
TABLES: YEZFIS0170.         " [FI] Structure for Program YEZFIR0080 Screen 0100

*----------------------------------------------------------------------*
* TYPES
*----------------------------------------------------------------------*
TYPES: BEGIN OF TY_S_KNB1,
         KUNNR   TYPE KNB1-KUNNR,
         LIFNR   TYPE KNA1-LIFNR,
       END OF TY_S_KNB1.

TYPES: TY_T_KNB1   TYPE STANDARD TABLE OF TY_S_KNB1.
...
DATA: GT_OUTTAB           TYPE STANDARD TABLE OF YEZFIS0160.
DATA: GS_OUTTAB           TYPE YEZFIS0160.

DATA: GT_KNB1             TYPE TY_T_KNB1.
DATA: GS_KNB1             TYPE TY_S_KNB1.
...
SELECT-OPTIONS: S_KUNNR    FOR GS_OUTTAB-KUNNR
...
PARAMETERS:     P_APAR     TYPE XAPIT_IT AS CHECKBOX.
